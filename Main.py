...
def Q4a():
    ...
    wall1 = Wall({ 'orientation': 0 ,'width':7, 'height':2.6, 'edges': True})
    wall2 = Wall({'position':[0.2,-0.2,0], 'orientation': 90 ,'width':4, 'height':2.6, 'edges': True})
    wall3 = Wall({'position': [0, 4.2, 0], 'orientation': 0 ,'width':7, 'height':2.6, 'edges': True})
    wall4 = Wall({'position': [0.2, -7, 0], 'orientation': 90 ,'width':4, 'height':2.6, 'edges': True})  

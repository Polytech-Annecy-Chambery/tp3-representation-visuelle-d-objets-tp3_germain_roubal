...
class Configuration:
    ...
    def processMouseMotionEvent(self):
        if self.event.type == pygame.MOUSEMOTION and pygame.mouse.get_pressed()[0]==1 :
            gl.glRotatef(1,self.event.rel[1],0,self.event.rel[0])
        elif self.event.type == pygame.MOUSEMOTION and pygame.mouse.get_pressed()[2]==1 :
